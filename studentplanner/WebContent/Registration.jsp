		...
		<div class="modal-body row col-sm-6 col-sm-offset-3 well">
			<form id="registrationForm" novalidate="novalidate">
				<div class="form-group">
					<label for="firstname" class="control-label" style="color: black">First
						Name</label> <input type="text" class="form-control" id="firstname"
						name="firstname" value="" required
						title="Please enter your first name"> <span
						class="help-block"></span>
				</div>
				<div class="form-group">
					<label for="lastname" class="control-label" style="color: black">Last
						Name</label> <input type="text" class="form-control" id="lastname"
						name="lastname" value="" required
						title="Please enter your last name"> <span
						class="help-block"></span>
				</div>
				<div class="form-group">
